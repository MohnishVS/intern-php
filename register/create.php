			...
			<div class="form-group">
				<form>
					...
					<div class="form-group">
						...
						<input type="text" name="username" id="username" autocomplete="username" class="form-control" onkeyup='usercheck();' required minlength=4 maxlength=8 placeholder="username"><br />
						<div id="message1"></div>
					</div>
					<div class="form-group">
						<label for="email">Email:</label><br />
						<input type="email" name="email" id="email" class="form-control" pattern=".+@+." onkeyup='emailcheck();' required placeholder="Email"><br />
						<div id="message2"></div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="password" name="confirm_password" class="form-control" id="confirm_password" onkeyup='check();' onchange="save();" required minlength=4 maxlength=8 placeholder="********"><br />
						<div id="message"></div>
